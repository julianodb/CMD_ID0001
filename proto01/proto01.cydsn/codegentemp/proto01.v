// ======================================================================
// proto01.v generated from TopDesign.cysch
// 02/11/2014 at 14:10
...
// PGA_v2_0(Gain=0, Power=1, VddaValue=5, Vref_Input=1, CY_COMPONENT_NAME=PGA_v2_0, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=PGA_1, CY_INSTANCE_SHORT_NAME=PGA_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=PGA_1, )
module PGA_v2_0_0 (
    Vin,
    Vref,
    Vout);
...
module ADC_DelSig_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("4268c807-2a9d-4062-ae3d-8a6a6d2d01be/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("4268c807-2a9d-4062-ae3d-8a6a6d2d01be/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1865671641.79104"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
// Filter_v2_20(ChannelEnableA=true, ChannelEnableB=false, ChannelSettingsA=<enabled=true>\r\n<userEntryEnabled=false>\r\n<sampleRate=8>\r\n<filterGain_dB=0>\r\n<filterGain_Linear=1>\r\n<gainScale=DB>\r\n<width=WIDTH_16>\r\n<signal=POLL>\r\n<stage_count=2>\r\n<bus_clock=0.56>\r\n<stage0=\r\n    <design_type=BIQUAD>\r\n    <pass_type=HIGH_PASS>\r\n    <shape=BUTTERWORTH>\r\n    <order=8>\r\n    <ripple=0.1>\r\n    <primary_freq=0.0005>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userOrder=1>\r\n>\r\n<stage1=\r\n    <design_type=BIQUAD>\r\n    <pass_type=LOW_PASS>\r\n    <shape=BUTTERWORTH>\r\n    <order=4>\r\n    <ripple=0.1>\r\n    <primary_freq=0.15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userOrder=1>\r\n>\r\n<stage2=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage3=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage4=\r\n    <design_type=FIR>\r\n    <pass_type=HIGH_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=64>\r\n    <primary_freq=0.0005>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage5=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=0.15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage6=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n<stage7=\r\n    <design_type=FIR>\r\n    <pass_type=LOW_PASS>\r\n    <window_type=HAMMING>\r\n    <tap_count=16>\r\n    <primary_freq=15>\r\n    <bandwidth=10>\r\n    <UserCoefficient=>\r\n    <userTapCount=1>\r\n>\r\n, ChannelSettingsB="", ChannelTypeA=255, ChannelTypeB=0, CoefficientEntryEnableA=false, CoefficientEntryEnableB=false, DisplaySettingsA=50307, DisplaySettingsB=50307, DmaEnableA=false, DmaEnableB=false, IrqEnableA=false, IrqEnableB=false, MinBusClockVal=0.56, CY_COMPONENT_NAME=Filter_v2_20, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Filter_1, CY_INSTANCE_SHORT_NAME=Filter_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Filter_1, )
module Filter_v2_20_2 (
    DMA_Req_A,
    DMA_Req_B,
    Interrupt);
    output      DMA_Req_A;
...
module top ;
	...
	wire [0:0] tmpOE__SENSOROUTPUT_net;
	wire [0:0] tmpFB_0__SENSOROUTPUT_net;
	wire [0:0] tmpIO_0__SENSOROUTPUT_net;
	wire [0:0] tmpINTERRUPT_0__SENSOROUTPUT_net;
	electrical [0:0] tmpSIOVREF__SENSOROUTPUT_net;

	cy_psoc3_pins_v1_10
		#(.id("f436b287-7e53-4cfe-a028-7baa5f0d314a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		SENSOROUTPUT
		 (.oe(tmpOE__SENSOROUTPUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SENSOROUTPUT_net[0:0]}),
		  .analog({Net_4}),
		  .io({tmpIO_0__SENSOROUTPUT_net[0:0]}),
		  .siovref(tmpSIOVREF__SENSOROUTPUT_net),
		  .interrupt({tmpINTERRUPT_0__SENSOROUTPUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SENSOROUTPUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2860e776-5369-4eb1-b65a-b2c0da6a1a25"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0c0adda4-174c-4418-89e5-659466a3c2de"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam VDAC8_2.Initial_Value = 187;
	...
	cy_psoc3_pins_v1_10
		#(.id("c25ccd7c-efb9-4171-a480-5825f7c939b6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
